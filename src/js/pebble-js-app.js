...
Pebble.addEventListener('showConfiguration', function(e) {
  var url = 'http://pebble.geraintwhite.co.uk/?options=batteryPercentage+showDate+invertColours+bluetoothVibrate+hourlyVibrate';
...
Pebble.addEventListener('webviewclosed', function(e) {
  ...
  var data = {
    ...
    'KEY_HOURLY_VIBRATE': config.hourlyVibrate ? 1 : 0
  };
